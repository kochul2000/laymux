...
- `claude-osc-handle.md`: integration guide for every OSC/DEC escape sequence Claude Code uses (byte formats, spec links, xterm.js API examples, Tauri/Windows patterns).

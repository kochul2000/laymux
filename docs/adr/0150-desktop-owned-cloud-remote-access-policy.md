...
- Superseded in part by: [ADR-0159](0159-android-e2e-websocket-output-transport.md) — `androidE2eOnly`에서도 고정된 encrypted output WebSocket 하나를 허용함. 일반 Remote WebSocket 거부와 PC 소유 정책은 유지한다.

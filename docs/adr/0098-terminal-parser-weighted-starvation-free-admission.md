...
- checkpoint도 전역 단일 lease와 64 KiB contended quantum을 사용하므로 정상 mounted 생명주기의 active desktop xterm physical write는 앱 전체에서 최대 하나다. unmount/profile replacement의 bounded stale callback 예외는 Decision 6을 따른다.

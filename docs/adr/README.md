...
| [0117](0117-codex-session-restore.md) | Codex CLI 세션은 최상위 rollout과 terminal CWD를 연결해 안전한 resume 명령으로 복원 | Accepted |
| [0118](0118-settings-type-error-partial-recovery.md) | settings.json 타입 오류는 경로 단위로 드롭해 부분 복구하고, 확인 전까지 파일에 쓰지 않는다 | Proposed |

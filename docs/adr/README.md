...
| [0211](0211-workspace-selector-destructive-actions-require-two-activations.md) | Workspace selector 파괴적 action은 같은 컨트롤의 연속 두 번 활성화를 요구한다 (0033·0035 정정) | Proposed |

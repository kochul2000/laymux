...
| [0148](0148-bounded-multi-path-selection-links.md) | 선택 경로 링크는 bounded maximal-munch 복수 후보를 사용한다 (0045 확장) | Superseded by 0165 |
...
| [0157](0157-android-pairing-sheet-over-live-cloud-webview.md) | Android pairing sheet는 비활성 Cloud WebView 위의 secure overlay다 (0149 확장) | Superseded by 0178 |
...
| [0163](0163-android-foreground-preserves-remote-document.md) | Android foreground는 Remote 문서를 유지하고 native transport만 복원한다 (0155 확장) | Accepted |
| [0164](0164-ime-textarea-diff-skip-while-sending.md) | 조합 finalize 대기 중에는 229 textarea-diff를 보내지 않는다 (0093 확장) | Proposed |
| [0165](0165-desktop-path-link-validates-on-pointer-release.md) | 데스크톱 path-link는 pointer release의 최종 선택만 한 번 검증한다 (0148 대체) | Accepted |
| [0166](0166-remote-workspace-create-action.md) | Remote는 lease 보유자에게 선택한 레이아웃의 워크스페이스 생성 액션을 제공한다 | Accepted |
| [0167](0167-grok-usage-drops-legacy-monthly.md) | Grok 사용량 닫힌 집합에서 레거시 monthly 행을 뺀다 (0156 Amend) | Accepted |
| [0168](0168-android-remote-resource-memory-cache-and-transfer-overlay.md) | Android 원격 자원 — Cache-Control 존중 메모리 캐시 + 전송 진행 오버레이 | Accepted |
| [0169](0169-remote-client-hashed-immutable-assets-and-gzip.md) | Remote 클라이언트 — 셸 + 콘텐츠 해시 불변 자산 분리, minify·gzip 전송 | Accepted |
...
| [0237](0237-remote-floating-input-controls.md) | Remote 플로팅 입력은 기기 로컬 배치와 기존 액션을 공유한다 (0213·0228 확장) | Superseded by 0265 (패드 초기 기본값만) |
...
| [0243](0243-settings-mcp-scoped-discovery-and-remote-device-bridge.md) | 설정 MCP의 범위별 설명과 Remote 기기 적용 확인 | Accepted |
| [0244](0244-spreadsheet-selection-and-windowed-scroll.md) | 스프레드시트는 범위 선택과 스크롤 창으로 탐색한다 | Accepted |
| [0245](0245-empty-html-preview-os-handoff.md) | 빈 HTML 미리보기는 본문에서 PC 연결 프로그램 열기를 안내한다 | Accepted |
| [0246](0246-spreadsheet-demand-driven-reading.md) | 스프레드시트 셀 파싱은 스크롤 요청에 따라 진행한다 | Accepted |
| [0247](0247-usage-profile-login-recovery.md) | 사용량 조회는 선택한 실행 환경의 로그인 상태로 복구한다 | Accepted |
...
| [0263](0263-remote-tool-swipe-hint-removal.md) | Remote 도구의 상단 스와이프 안내 줄을 제거한다 | Accepted |
...
| [0266](0266-agent-connection-setup.md) | 에이전트 연결 설정은 선택한 프로필에서 검사하고 명시적으로 새 pane을 연다 | Proposed |

...
| [0161](0161-rendererless-terminal-session-startup.md) | terminal host가 0폭이어도 PTY·rendererless output surface를 시작하고 DOM renderer만 양의 크기를 기다린다 (0043·0127·0138 확장) | Proposed |

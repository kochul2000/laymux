...
| [0114](0114-sleep-prevention-mode.md) | 절전 방지는 설정이 모드를 소유하고 OS 억제는 Rust 단일 지점이 건다 (0115 가 모드 부분 정정) | Proposed |
| [0115](0115-sleep-prevention-two-axes.md) | 절전 방지는 수동 스위치와 자동 정책 두 축이고 상단 바 버튼은 수동 축만 표시한다 (0114 정정) | Proposed |

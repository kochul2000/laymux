...
| `GrokUsageView` | 자유 | Grok Build 사용량 모니터. `/usage` 화면의 닫힌 행 키 `weekly` · `monthly` · `credits` · `payg` 를 `usage.grok.visibleRows` 로 고른다([ADR-0156](../adr/0156-grok-first-class-agent.md)). |

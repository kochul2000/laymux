...
| POST | `/api/v1/panes/:index/resize` | Pane 크기 조정 — 공유 경계를 이웃과 함께 이동 (`dw`/`dh` 상대 delta, 해당 축에 경계가 없으면 오류. [data-flow §5](./data-flow.md), [ADR-0068](../adr/0068-pane-resize-single-boundary-owner.md)) |
...
| `resize_pane` | bridge_request | 팬 크기 조정 — 공유 경계를 이웃과 함께 이동 (`dw`/`dh` 상대 delta, 해당 축에 경계가 없으면 오류. [ADR-0068](../adr/0068-pane-resize-single-boundary-owner.md)) |

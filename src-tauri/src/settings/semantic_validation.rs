...
use crate::constants::{
    ...
    PROFILE_CURSOR_SHAPES, SETTINGS_LANGUAGES, SLEEP_PREVENTION_MODES,
    TERMINAL_ACTIVITY_WIDGET_SCOPES, TERMINAL_SCROLLBAR_STYLES, USAGE_WIDGET_BAR_HEIGHT_MAX,
...
pub fn validate_settings(settings: &Settings) -> Vec<SettingsIssue> {
    ...
    enum_value(
        ...
        &settings.power.sleep_prevention,
